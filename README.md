...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter@v0.2.2-esm/index.mjs';
```
...
import iter from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter@v0.2.2-esm/index.mjs';
